...
const Contact = () => {
  const socialLinks = [
    ...
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://www.linkedin.com/in/shailu-mirsha-b83ba0360?trk=contact-info",
      color: "from-blue-600 to-blue-400",
    },
    {
      name: "GitHub",
      icon: Github,
      href: "https://github.com/Shailu-Mirsha", 
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ...
              to say hi, feel free to reach out through any of these platforms.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {socialLinks.map((link, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-br ${link.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                >
